package com.triador.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.triador.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.triador.springboot.model" });
